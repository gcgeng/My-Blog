---
title: '[bzoj3876][AHOI2014]支线剧情——上下界费用流'
tags: [网络流, 上下界网络流, 费用流]
date: 2017-02-21 11:42:00
---
...
![](http://i2.muimg.com/567571/03995e4b2e37f873.png)
变成
![](http://i2.muimg.com/567571/347c8b27c0561110.png)
至于建立新图，我是这样建立的（如图）
另外推荐一篇文章：[Menci的博客](https://oi.men.ci/network-flow-with-bounds/)
# 代码
```cpp
#include <bits/stdc++.h>
using namespace std;
